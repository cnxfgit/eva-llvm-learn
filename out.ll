...
@1 = private unnamed_addr constant [31 x i8] c"(calculate 10 transform) = %d\0A\00", align 1
...
entry:
  ...
  %5 = call i32 @calculate(i32 10, %Transformer* %0)
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @1, i32 0, i32 0), i32 %5)
  ret i32 0
}
...
define i32 @calculate(i32 %x, %Transformer* %modify) {
entry:
